...
wk.add({
	...
	{ "<leader>fg", group = "Git" },
	{ "<leader>fgR", "<cmd>Telescope git_branch_remote<cr>", desc = "Git Remote Branches" },
	...
	{ "<leader>fgg", "<cmd>Telescope git_status<cr>", desc = "Git Status" },
	{ "<leader>fgr", "<cmd>Telescope git_bcommits<cr>", desc = "Git Branch Commits" },
