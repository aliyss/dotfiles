...
in
  mkIf cfg.llm {
    ...
    # --- Local llama-cpp runtime via llama-swap — DISABLED. The Affinity AI
    #     brain now talks to OpenRouter (see home-manager/apps/affinity-ai.nix),
    #     so no llama-cpp server runs on this machine. Uncomment to re-enable.
    # services.llama-swap = {
    #   enable = true;
    #   port = 8012;
    #   openFirewall = true;
